            ...
            <div class="max-w-md w-full mx-auto space-y-8">
                ...
                <form @submit.prevent="login()" class="space-y-5">
                    ...
                    <button type="submit" :disabled="isLoading" class="w-full py-3 bg-slate-950 hover:bg-slate-900 text-white font-bold text-xs rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-75 disabled:cursor-not-allowed">
                        <span x-show="!isLoading" class="flex items-center justify-center gap-2">Masuk Portal <i data-lucide="arrow-right" class="w-4 h-4"></i></span>
                    ...
                    try {
                        ...
                        if (res.success) {
                            this.bookings = res.data.map(b => ({
                                ...
                                unit_photo: b.facility.photo ? (b.facility.photo.startsWith('http') ? b.facility.photo : API_URL.replace('/api', '') + b.facility.photo) : '/images/bungalow_buah.jpg',
